export const continents = [
  {
    ...
    learnurl: "https://en.wikipedia.org/wiki/Africa",
    mapurl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Africa_%28orthographic_projection%29.svg/1024px-Africa_%28orthographic_projection%29.svg.png",
  },
  {
    heading: "Antartica",
    content:
      "Antartica is Earth's southernmost continent. It contains the geographic South Pole and is situated in the Antarctic region of the Southern Hemisphere, almost entirely south of the Antarctic Circle, and is surrounded by the Southern Ocean. At 14,200,000 square kilometres (5,500,000 square miles), it is the fifth-largest continent and nearly twice the size of Australia.",
    learnurl: "https://en.wikipedia.org/wiki/Antartica",
    mapurl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Antarctica_%28orthographic_projection%29.svg/240px-Antarctica_%28orthographic_projection%29.svg.png",
  },
  {
    heading: "Asia",
    content:
    ...
    learnurl: "https://en.wikipedia.org/wiki/Asia",
    mapurl:
  ...
  },
  {
    heading: "Australia",
    content:
      "Australia, officially known as the Commonwealth of Australia, is a sovereign country comprising the mainland of the Australian continent, the island of Tasmania, and numerous smaller islands.[13] It is the largest country in Oceania and the world's sixth-largest country by total area. The population of 26 million[7] is highly urbanised and heavily concentrated on the eastern seaboard.[14] Australia's capital is Canberra, and its largest city is Sydney.",
    learnurl: "https://en.wikipedia.org/wiki/Australia",
    mapurl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Australia_with_AAT_%28orthographic_projection%29.svg/1024px-Australia_with_AAT_%28orthographic_projection%29.svg.png",
  },
  {
    heading: "Europe",
    content:
    ...
    learnurl: "https://en.wikipedia.org/wiki/Europe",
    mapurl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Europe_orthographic_Caucasus_Urals_boundary_%28with_borders%29.svg/1024px-Europe_orthographic_Caucasus_Urals_boundary_%28with_borders%29.svg.png",
  },
  {
    heading: "North America",
    content:
      "North America is a continent entirely within the Northern Hemisphere and almost all within the Western Hemisphere. It can also be described as a northern subcontinent of the Americas, or America, in models that use fewer than seven continents.",
    learnurl: "https://en.wikipedia.org/wiki/North_America",
    mapurl:
  ...
  },
  {
    ...
    learnurl: "https://en.wikipedia.org/wiki/South_America",
    mapurl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/South_America_%28orthographic_projection%29.svg/1024px-South_America_%28orthographic_projection%29.svg.png",
  },
];
